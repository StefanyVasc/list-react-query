...
export function CreateTagForm() {
  ...
  // no primeiro momento title estará vazio, então se houver algo no title a
  // getSlugFromString será chamada
  const slug = watch('title') ? getSlugFromString(watch('title')) : ''

  // mutateAsync é a função que vai executar a mutationFn
